...
<html lang="en">
  <head>
    ...
    <title>Prokompim - Input Disposisi</title>
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <div class="body">
                ...
                @endif
                <form action="{{ route('dispo.inputDispo') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <label for="tujuan_dispo" class="form-label">Tujuan Disposisi</label>
                        <select class="form-select" id="tujuan_dispo" name="tujuan_dispo" required>
                            <option selected>-- Pilih Tujuan Disposisi --</option>
                            @foreach ($namaTujuan as $tujuan)
