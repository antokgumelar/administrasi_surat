...
<html lang="en">
  <head>
    ...
    <title>Prokompim - Surat Baru</title>
    ...
    <div class="content">
        <div class="navigasi-bar">
            <div class="container group-list-list">
                ...
                <a href="{{ route('surat-baru-admin') }}"class="navbar-brand active">
        ...
        <div class="container mt-4">
            <h1 style="font-weight: bold;">Surat Baru</h1>
            <div class="body">
                @if(session('success'))
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ asset('uploads/'. $suratbaru->upload_data) }}" target="_blank">Lihat Dokumen</a>
                        </td>
                        <td>{{ $suratbaru->perihal_surat }}</td>
                        <td>{{ $suratbaru->status_surat }}</td>
                        <td>{{ $suratbaru->created_at}}</td>
                        <td>
                            <button class="btn btn-warning btn-dispo" data-kode_surat="{{ $suratbaru->kode_surat }}">Disposisi Surat</button>
                        </td>
        ...
        <script>
            document.querySelectorAll('.btn-dispo').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    window.location.href = `/disposisi-admin/${kodeSurat}`;
                });
            });
        </script>
