    ...
    <div class="content">
        <div class="navigasi-bar">
            <div class="container group-list-list">
                ...
                <a href="{{ route('surat-perangkat') }}" class="navbar-brand notif">
                    ...
                    @if($totalProses > 0)
                        <span class="position-absolute translate-middle p-1 bg-warning border border-light rounded-circle">
                            <span class="visually-hidden">Notifikasi Disposisi Baru</span>
                        </span>
                    @endif
                </a>
                <a href="{{ route('laporan-perangkat') }}" class="navbar-brand active">
        ...
        <div class="container mt-4">
                ...
                <form id="formFilter" class="group-filter w-50" method="GET" action="{{ route('laporan-perangkat') }}">
                    <div class="mb-3">
                        ...
                        <br>
                        <button type="submit" class="btn btn-secondary w-100">Cari Surat</button>
                    </div>
                ...
                <div id="laporan">
                    ...
                    @else
                        <div class="fw-bold mt-3">Data tidak ditemukan</div>
                    @endif
                </div>
            </div>
        </div>
