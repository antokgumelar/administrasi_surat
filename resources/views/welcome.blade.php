...
<html lang="en">
  ...
  <body>
    <div class="content">
        <div class="container">
            <div class="judul-lacak-surat">
                <div class="judul">
                    <h2 style="font-weight: bold;">Selamat Datang Di PROKOMPIM</h2>
                    <h5>Sistem Administrasi Surat</h5>
                </div>
                <form action="{{ route('cari-surat')}}" method="GET" class="lacak-surat">
                    ...
                    placeholder="Masukkan Kode Surat / No Surat / Pengirim / Perihal"  value="{{ request('kataKunci') }}"required>
                    <button type="submit" class="btn btn-primary">Lacak Surat</button>
                </form>
                <i class="bi bi-person-fill login-user" onclick="window.open('{{ route('login-user') }}','_blank')"> Login Sebagai User</i>
                <i class="bi bi-person-fill-gear login-user" onclick="window.open('{{ route('login-admin') }}','_blank')"> Login Sebagai Admin</i>
            </div>
        </div>
