  ...
  <body>
    <div class="content">
        <div class="login-user">
                ...
                @endif
            <form class="group-login" action="{{ route('login-user') }}" method="POST">
                @csrf
                <h2 style="font-weight: bold;">Login User</h2>
                <div class="mb-3">
                    <label for="exampleFormControl1" class="form-label">Username</label>
                    <input type="text" class="form-control" name="username_instansi" placeholder="Masukkan Username" required>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControl1" class="form-label">Password</label>
                    <input type="password" class="form-control" name="password_instansi" placeholder="Masukkan Password" required>
                </div>
